// components/UserChatInterface/UserChatInterface.js
...
const UserChatInterface = ({ user = { username: 'User' }, onLogout = () => {} }) => {
    ...
    if (inputMessage.trim() || uploadedFiles.length > 0) {
      ...
      setTimeout(() => {
        ...
        if (newMessage.files.length > 0) {
          ...
          responseText += ` along with ${newMessage.files.length} file(s): ${fileNames}. I can help you analyze or work with these files. What would you like me to do with them?`;
        } else {
          responseText = `I understand your message: "${newMessage.text}". How can I help you further?`;
        }
  ...
  const handleFileUpload = (e) => {
    ...
    if (file) {
      const newFile = {
        ...
        size: file.size,
        type: file.type,
        file: file // Store the actual file object for potential processing
      };
  ...
  const handleReadAloud = (messageText) => {
    ...
    if (messageIndex > 0) {
      ...
      setTimeout(() => {
        ...
        if (userMessage.files && userMessage.files.length > 0) {
          ...
          regeneratedText = `Here's an alternative response to your message`;
          if (userMessage.text && userMessage.text !== "Uploaded files") {
            regeneratedText += ` "${userMessage.text}"`;
          }
          regeneratedText += ` and the uploaded file(s): ${fileNames}. Let me provide a different perspective or approach.`;
        } else {
          regeneratedText = `Here's a regenerated response to: "${userMessage.text}". This is a different take on the same question.`;
        }
  ...
  const handleDownload = (messageText, messageId) => {
    ...
    element.download = `message_${messageId}.txt`;
    ...
    <div className="user-chat-interface">
      ...
      <div className="chat-main">
        <div className="chat-background-logo">
          {/* Background logo - replace with your logo */}
          <img 
            src="/path-to-your-logo.png" 
            alt="Background Logo" 
          ...
          {messages.length === 0 && (
            <div className="empty-chat">
              <div className="empty-chat-content">
                ...
                <p>Start a conversation by typing a message below or upload files to analyze</p>
              </div>
            </div>
          )}
        ...
        <div className="chat-input-area">
          ...
          <div className="input-container">
            ...
            <input
              ...
              placeholder={uploadedFiles.length > 0 ? "Add a message about your files..." : "Type your message..."}
